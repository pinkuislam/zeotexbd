...
@section('content')
    <section class="content">
        <div class="nav-tabs-custom">
            <a href="{{ route('admin.basic.product-other.index') . qString() }}" class="btn btn-info" style="margin: 10px;">
                Back
            </a>
            <div class="tab-content">
                <form method="POST" action="{{ route('admin.basic.other-products.ecommerce.store').qString() }}" id="are_you_sure" enctype="multipart/form-data">
                    @csrf
                ...
                <script>
                    ...
                    function removeFilesRowAjax(id, k) {
                        $.ajax({
                            ...
                            dataType: "JSON",
                            data: {id: id},
                            url: "{{ route('admin.basic.other-products.image-destroy') }}",
                            headers: {
