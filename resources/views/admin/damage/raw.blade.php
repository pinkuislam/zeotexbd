    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            <li {{ (isset($list)) ? 'class=active' : '' }}>
                <a href="{{ route('admin.damage.raw.index').qString() }}">
                    <i class="fa fa-list" aria-hidden="true"></i> Fabrics Damage List
                </a>
            </li>
            @can('show damage')
            <li {{ (isset($create)) ? 'class=active' : '' }}>
                <a href="{{ route('admin.damage.raw.create').qString() }}">
                    <i class="fa fa-plus" aria-hidden="true"></i> Add Fabrics Damage
                </a>
            </li>
            @endcan
            @if (isset($edit))
            <li class="active">
                <a href="#">
                    <i class="fa fa-edit" aria-hidden="true"></i> Edit Fabrics Damage
                </a>
            </li>
            @endif
            ...
            <li class="active">
                <a href="#">
                    <i class="fa fa-list-alt" aria-hidden="true"></i> Fabrics Damage Details
                </a>
            </li>
            @endif
        </ul>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active">
                <div class="box-body">
                    <form method="POST" action="{{ isset($edit) ? route('admin.damage.raw.update', $edit) : route('admin.damage.raw.store') }}{{ qString() }}" id="are_you_sure" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
                                        ...
                                        <tbody id="responseHtml">
                                            @foreach ($items as $key => $item)
                                                <tr class="subRow" id="row{{ $key }}">
                                                    ...
                                                    <td>
                                                        <input type="text"  name= "unit_price[]" id="unit_price{{ $key }}" class="form-control" readonly value="{{  $item->unit_price ?  $item->unit_price : ''}}">
                                                    </td>
                                                    <td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            @can('show damage')
                                                <li><a href="{{ route('admin.damage.raw.show', $val->id) . qString() }}"><i
                                                            class="fa fa-eye"></i> Show</a></li>
                                            @endcan
                                            @can('edit damage')
                                                <li><a href="{{ route('admin.damage.raw.edit', $val->id) . qString() }}"><i
                                                            class="fa fa-pencil"></i> Edit</a></li>
                                            @endcan
                                            @can('delete damage')
                                                <li><a onclick="deleted('{{ route('admin.damage.raw.destroy', $val->id) . qString() }}')"><i
    ...
    <script>
        ...
        function addRow(key) {
            ...
            var html = `<tr class="subRow" id="row` + newKey + `">
                ...
                <td>
                    <input type="text"  name="unit_price[]" id="unit_price` + newKey + `" class="form-control" readonly>
                </td>
                <td>
