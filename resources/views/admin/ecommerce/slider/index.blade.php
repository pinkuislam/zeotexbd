    ...
    <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
            <div class="tab-pane active">
                <form method="GET" action="{{ route('admin.ecommerce.sliders.index') }}" class="form-inline">
                    <div class="box-header text-right">
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <a class="btn btn-custom btn-flat" href="{{ route('admin.ecommerce.sliders.index') }}">X</a>
                            </div>
                        </div>
                    </div>
                </form>
                    ...
                    <table class="table table-bordered table-hover dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $key + 1 }}</td>
                                <td>
                                    {!! viewImg('sliders', $val->image, ['popup' => 1, 'style' => 'width:100px; height:80px;']) !!}
                                </td>
                                <td>{{ $val->title }}</td>
                                <td>{{ $val->link }}</td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            ...
                                            @can('show slider')
                                                <li><a
                                                        href="{{ route('admin.ecommerce.sliders.show', $val->id) . qString() }}"><i
                                            ...
                                            @can('edit slider')
                                                <li><a
                                                        href="{{ route('admin.ecommerce.sliders.edit', $val->id) . qString() }}"><i
                                                            class="fa fa-pencil"></i> Edit</a></li>
                                            @endcan
                                            @can('delete slider') 
                                            <li>
                                                <a href="javascript:void(0);" onclick="deleted('{{ route('admin.ecommerce.sliders.destroy', $val->id).qString() }}')">
