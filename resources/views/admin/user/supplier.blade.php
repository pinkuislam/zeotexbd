        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li {{ isset($list) ? 'class=active' : '' }}>
                    <a href="{{ route('admin.user.supplier.index') . qString() }}">
                ...
                @can('add supplier')
                    <li {{ isset($create) ? 'class=active' : '' }}>
                        <a href="{{ route('admin.user.supplier.create') . qString() }}">
                ...
                @if (isset($edit))
                    <li class="active">
                        <a href="#">
                            <i class="fa fa-edit" aria-hidden="true"></i> Edit Supplier
                        </a>
                    </li>
                @endif
                ...
                @if (isset($show))
                    <li class="active">
                        <a href="#">
                            <i class="fa fa-list-alt" aria-hidden="true"></i> Supplier Details
                        </a>
                    </li>
                @endif
            </ul>
            ...
            <div class="tab-content">
                        ...
                        <div class="box-body table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <th>Opening Due</th>
                                    <th>:</th>
                                    <td>{{ number_format($data->opening_due, 2) }}</td>
                                </tr>
                                <tr>
                                    <th>Address</th>
                                    <th>:</th>
                ...
                @elseif(isset($edit) || isset($create))
                    <div class="tab-pane active">
                        <div class="box-body">
                            <form method="POST"
                                action="{{ isset($edit) ? route('admin.user.supplier.update', $edit) : route('admin.user.supplier.store') }}{{ qString() }}"
                                ...
                                <div class="row">
                                    <div class="col-sm-8">
                                        ...
                                        <div class="form-group{{ $errors->has('opening_due') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="decimal" class="form-control" name="opening_due"
                                                    value="{{ old('opening_due', isset($data) ? $data->opening_due : '0') }}">
                ...
                @elseif (isset($list))
                    <div class="tab-pane active">
                        <form method="GET" action="{{ route('admin.user.supplier.index') }}" class="form-inline">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a class="btn btn-warning btn-flat"
                                            href="{{ route('admin.user.supplier.index') }}">X</a>
                                    </div>
                                </div>
                            </div>
                        </form>
                                    ...
                                    @foreach ($records as $val)
                                        <tr>
                                            ...
                                            <td style="text-align:right">
                                                {{ number_format($val->opening_due, 2) }}</td>
                                            <td>{{ $val->address }}</td>
                                            <td>{{ $val->status }}</td>
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right">
                                                        @can('show supplier')
                                                            <li><a
                                                                    href="{{ route('admin.user.supplier.show', $val->id) . qString() }}"><i
                                                                        class="fa fa-eye"></i> Show</a></li>
                                                        @endcan

                                                        @can('edit supplier')
                                                            <li><a
                                                                    href="{{ route('admin.user.supplier.edit', $val->id) . qString() }}"><i
                                                                        class="fa fa-pencil"></i> Edit</a></li>
                                                        @endcan

                                                        @can('delete supplier')
                                                            <li><a
                                                                    onclick="activity('{{ route('admin.user.supplier.status', $val->id) . qString() }}')"><i
