        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                @if (isset($edit))
                    <li class="active">
                        <a href="#">
                            <i class="fa fa-edit" aria-hidden="true"></i> Edit Reseller
                        </a>
                    </li>
                @endif
                @if (isset($show))
                    <li class="active">
                        <a href="#">
                            <i class="fa fa-list-alt" aria-hidden="true"></i> Reseller Details
                        </a>
                    </li>
                @endif
            </ul>
            ...
            <div class="tab-content">
                ...
                @elseif(isset($edit) || isset($create))
                    <div class="tab-pane active">
                        <div class="box-body">
                            <form method="POST"
                                action="{{ isset($edit) ? route('admin.user.reseller.update', $edit) : route('admin.user.reseller.store') }}{{ qString() }}"
                ...
                @elseif (isset($list))
                    <div class="tab-pane active">
                        <form method="GET" action="{{ route('admin.user.reseller.index') }}" class="form-inline">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a class="btn btn-custom btn-flat"
                                            href="{{ route('admin.user.reseller.index') }}">X</a>
                                    </div>
                                </div>
                            </div>
                        </form>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        @can('show reseller')
                                                            <li><a href="{{ route('admin.user.reseller.show', $val->id) . qString() }}"><i
                                                                        class="fa fa-eye"></i> Show</a></li>
                                                        @endcan

                                                        @can('edit reseller')
                                                            <li><a href="{{ route('admin.user.reseller.edit', $val->id) . qString() }}"><i
                                                                        class="fa fa-pencil"></i> Edit</a></li>
                                                        @endcan
                                                        @can('price_setup reseller')
                                                        <li>
                                                            <a href="{{ route('admin.user.reseller.price', $val->id) . qString() }}"><i class="fa fa-money"></i> Price Setup</a>
                                                        </li>
                                                        @endcan
                                                        @can('delete reseller')
                                                            <li><a onclick="deleted('{{ route('admin.user.reseller.destroy', $val->id) . qString() }}')"><i
