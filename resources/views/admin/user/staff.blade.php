        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li {{ isset($list) ? 'class=active' : '' }}>
                    <a href="{{ route('admin.user.staff.index') . qString() }}">
                        <i class="fa fa-list" aria-hidden="true"></i> Staff List
                    </a>
                </li>
                @can('add staff')
                    <li {{ isset($create) ? 'class=active' : '' }}>
                        <a href="{{ route('admin.user.staff.create') . qString() }}">
                ...
                @if (isset($edit))
                    <li class="active">
                        <a href="#">
                            <i class="fa fa-edit" aria-hidden="true"></i> Edit Staff
                        </a>
                    </li>
                @endif
                @if (isset($show))
                    <li class="active">
                        <a href="#">
                            <i class="fa fa-list-alt" aria-hidden="true"></i> Staff Details
                        </a>
                    </li>
                @endif
            </ul>
            ...
            <div class="tab-content">
                ...
                @elseif(isset($edit) || isset($create))
                    <div class="tab-pane active">
                        <div class="box-body">
                            <form method="POST"
                                action="{{ isset($edit) ? route('admin.user.staff.update', $edit) : route('admin.user.staff.store') }}{{ qString() }}"
                ...
                @elseif (isset($list))
                    <div class="tab-pane active">
                        <form method="GET" action="{{ route('admin.user.staff.index') }}" class="form-inline">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a class="btn btn-custom btn-flat"
                                            href="{{ route('admin.user.staff.index') }}">X</a>
                                    </div>
                                </div>
                            </div>
                        </form>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        @can('show staff')
                                                            <li><a href="{{ route('admin.user.staff.show', $val->id) . qString() }}"><i
                                                                        class="fa fa-eye"></i> Show</a></li>
                                                        @endcan

                                                        @can('edit staff')
                                                            <li><a href="{{ route('admin.user.staff.edit', $val->id) . qString() }}"><i
                                                                        class="fa fa-pencil"></i> Edit</a></li>
                                                        @endcan

                                                        @can('delete staff')
                                                            <li><a onclick="deleted('{{ route('admin.user.staff.destroy', $val->id) . qString() }}')"><i
