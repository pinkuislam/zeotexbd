        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li {{ isset($list) ? 'class=active' : '' }}>
                    <a href="{{ route('admin.user.seller.index') . qString() }}">
                        <i class="fa fa-list" aria-hidden="true"></i> Seller List
                    </a>
                </li>
                @can('add seller')
                    <li {{ isset($create) ? 'class=active' : '' }}>
                        <a href="{{ route('admin.user.seller.create') . qString() }}">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add Seller
                        </a>
                    </li>
                @endcan
                ...
                @if (isset($edit))
                    <li class="active">
                        <a href="#">
                            <i class="fa fa-edit" aria-hidden="true"></i> Edit Seller
                        </a>
                    </li>
                @endif
                ...
                @if (isset($show))
                    <li class="active">
                        <a href="#">
                            <i class="fa fa-list-alt" aria-hidden="true"></i> Seller Details
                        </a>
                    </li>
                @endif
            </ul>
            ...
            <div class="tab-content">
                        ...
                        <div class="box-body table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if(isset($data->image))
                                        {!! viewImg('users', $data->image, ['popup' => 1, 'thumb' => 1, 'style' => 'width:50px;']) !!}
                                        @endif
                                    </td>
                                </tr>
                                <tr>
                ...
                @elseif(isset($edit) || isset($create))
                    <div class="tab-pane active">
                        <div class="box-body">
                            <form method="POST"
                                action="{{ isset($edit) ? route('admin.user.seller.update', $edit) : route('admin.user.seller.store') }}{{ qString() }}"
                ...
                @elseif (isset($list))
                    <div class="tab-pane active">
                        <form method="GET" action="{{ route('admin.user.seller.index') }}" class="form-inline">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a class="btn btn-custom btn-flat"
                                            href="{{ route('admin.user.seller.index') }}">X</a>
                                    </div>
                                </div>
                            </div>
                        </form>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        @can('show seller')
                                                            <li><a href="{{ route('admin.user.seller.show', $val->id) . qString() }}"><i
                                                                        class="fa fa-eye"></i> Show</a></li>
                                                        @endcan

                                                        @can('edit seller')
                                                            <li><a href="{{ route('admin.user.seller.edit', $val->id) . qString() }}"><i
                                                                        class="fa fa-pencil"></i> Edit</a></li>
                                                        @endcan

                                                        @can('delete seller')
                                                            <li><a onclick="deleted('{{ route('admin.user.seller.destroy', $val->id) . qString() }}')"><i
