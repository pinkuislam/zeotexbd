    ...
    <section class="content">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li class="active">
                    <a>
                        <i class="fa fa-list" aria-hidden="true"></i> {{ __('Expense') }} {{ __('Reports') }}
                    </a>
                </li>
            </ul>
            ...
            <div class="tab-content">
                <div class="tab-pane active">
                    <form method="GET" action="{{ route('admin.report.expense') }}" class="form-inline">
                        <div class="box-header text-right">
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <a class="btn btn-warning btn-flat" href="{{ route('admin.report.expense') }}">X</a>
                                </div>
                            </div>
                        </div>
                    </form>
