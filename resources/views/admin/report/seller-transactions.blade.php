    ...
    <section class="content">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li>
                    <a href="{{ route('admin.report.seller') }}">
            ...
            <div class="tab-content">
                <div class="tab-pane active">
                    <form method="GET" action="{{ route('admin.report.seller-transactions') }}" class="form-inline">
                            ...
                            <div class="row">
                                    ...
                                    <select class="form-control select2" name="seller">
                                        ...
                                        @foreach ($users as $user)
                                            <option value="{{ $user->id }}"
                                                {{ Request::get('seller') == $user->id ? 'selected' : '' }}>
                                                {{ $user->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <a class="btn btn-warning btn-flat"
                                        href="{{ route('admin.report.seller-transactions') }}">X</a>
                                </div>
                            </div>
                        </div>
                    </form>
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th style="text-align: center">{{ number_format($adjustment, 2) }}</th>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                    @else
                        <h2 class="text-center" style="padding: 50px 0;">Select Seller first!</h2>
                    @endif
                </div>
            </div>
        </div>
