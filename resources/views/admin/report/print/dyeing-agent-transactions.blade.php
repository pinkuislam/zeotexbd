    ...
    <table class="table table-bordered border-dark">
        <thead>
            <tr>
                ...
                <th scope="col" style="text-align: left;font-size: 12px">Total Cost</th>
        ...
        <tbody>
            ...
            @if ($openingBalance->balance)
                ...
                <tr>
                    <th scope="col" style="text-align: left;font-size: 12px" colspan="9" class="text-center">Opening Balance</th>
