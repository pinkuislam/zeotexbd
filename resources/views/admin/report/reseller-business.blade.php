    ...
    <section class="content">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <li>
                    <a href="{{ route('admin.report.reseller-business-transactions') }}">
            ...
            <div class="tab-content">
                <div class="tab-pane active">
                    <form method="GET" action="{{ route('admin.report.reseller-business') }}" class="form-inline">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                @foreach ($reports as $val)
                                    <tr>
                                        <td><a
                                                href="{{ route('admin.report.reseller-business-transactions') . '?reseller_business=' . $val->id }}">{{ $val->code }}</a>
                                        </td>
                                        <td>{{ $val->name }}</td>
                                        <td>{{ $val->address }}</td>
                                        <td>{{ $val->mobile }}</td>
                                        ...
                                        <td style="text-align:right">{{ number_format($val->shippingChargeAmount, 2) }}</td>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th style="text-align: right;">{{ number_format($reports->sum('shippingChargeAmount'), 2) }}</th>
