            ...
            <div class="box">
                <div class="box-body">
                    ...
                    <form method="POST" action="{{ route('admin.profile') }}">
                        ...
                        <button class="btn btn-success btn-rounded btn-block" type="submit">Save change</button>
                    </form>
                </div>
            </div>
        </div>
            ...
            <div class="box">
                <div class="box-body">
                    ...
                    <form method="POST" action="{{ route('admin.profile.password') }}">
                        ...
                        <button class="btn btn-success btn-rounded btn-block" type="submit">Change password</button>
                    </form>
                </div>
            </div>
        </div>
