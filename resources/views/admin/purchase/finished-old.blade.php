        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li {{ isset($list) ? 'class=active' : '' }}>
                    <a href="{{ route('admin.purchase.finished.index') . qString() }}">
                        <i class="fa fa-list" aria-hidden="true"></i> Other Product Purchase List
                    </a>
                </li>

                @can('add purchase')
                    <li {{ isset($create) ? 'class=active' : '' }}>
                        <a href="{{ route('admin.purchase.finished.create') }}">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add Other Product Purchase
                        </a>
                    </li>
                @endcan
                ...
                @can('edit purchase')
                    @if (isset($edit))
                        <li class="active">
                            <a href="#">
                                <i class="fa fa-edit" aria-hidden="true"></i> Edit Other Product Purchase
                            </a>
                        </li>
                    @endif
                @endcan
                ...
                @can('show purchase')
                    @if (isset($show))
                        <li class="active">
                            <a href="#">
                                <i class="fa fa-list-alt" aria-hidden="true"></i> Other Product Purchase Detail
                            </a>
                        </li>
                    @endif
                @endcan
            ...
            <div class="tab-content">
                ...
                @elseif(isset($edit) || isset($create))
                    <div class="tab-pane active">
                        <div class="box-body">
                            <form method="POST"
                                action="{{ isset($edit) ? route('admin.purchase.finished.update', $edit) : route('admin.purchase.finished.store') }}{{ qString() }}"
                                                ...
                                                <tr class="subRow" id="row{{ $key }}">
                                                        ...
                                                        <select name="product_id[]" id="product_id{{ $key }}"
                                                            ...
                                                            @foreach ($products as $product)
                                                                <option data-unit_id="{{ $product->unit->id }}" data-unit_name="{{ $product->unit->name }}" data-unit_price="{{ $product->stock_price }}"
                                                                    ...
                                                                    {{ $product->name .' - '. optional($product->category)->name }} @if($product->item) - {{$product->item->name }} @endif
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <input type="number" class="form-control qty" name="quantity[]"
                                                            ...
                                                            onkeyup="chkItemPrice({{ $key }})" value="{{ $item->quantity }}">
                                                    </td>
                                                    <td>
                                                        <input type="number" class="form-control"
                                                            name="unit_price[]" id="unit_price{{ $key }}"
                                                            value="{{ $item->unit_price }}" onclick="chkItemPrice({{ $key }})"
                                                            onkeyup="chkItemPrice({{ $key }})">
                                                    </td>
                                                    <td>
                                    ...
                                    {{-- <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th >P.Qty</th>
                                                <th >P.Price</th>
                                                <th class="required">O.Qty</th>
                                                <th class="required">O.Price</th>
                                                <th class="required">Total Price</th>
                                            </tr>
                                        </thead>
                                        <tbody id="responseHtml">
                                            @foreach ($items as $key => $item)
                                                <tr class="subRow" id="row{{ $key }}">
                                                        ...
                                                        <select name="product_id[]" id="product_id{{ $key }}"
                                                            ...
                                                            @foreach ($products as $product)
                                                                <option data-unit_id="{{ $product->unit->id }}" data-unit_name="{{ $product->unit->name }}" data-unit_price="{{ $product->unit_price }}"
                                                                    value="{{ $product->id }}"
                                                                    {{ $item->product_id == $product->id ? 'selected' : '' }}>
                                                                    {{ $product->name .' - '. $product->category }} @if($product->item) - {{$product->item->name }} @endif
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <select name="p_unit_id[]" id="punit_id{{ $key }}"
                                                            class="form-control select2">
                                                            <option value="">Select Unit</option>
                                                            @foreach ($units as $unit)
                                                                <option value="{{ $unit->id }}" {{ $item->p_unit_id == $unit->id ? 'selected' : '' }}>
                                                                    {{ $unit->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </td>
                                                    <td>
                                                        <input type="number" class="form-control" name="p_quantity[]"
                                                            id="pquantity{{ $key }}"
                                                            onclick="chkItemPrice({{ $key }})"
                                                            onkeyup="chkItemPrice({{ $key }})" value="{{ $item->p_quantity }}">
                                                    </td>
                                                    <td>
                                                        <input type="number" class="form-control" name="p_unit_price[]" id="punit_price{{ $key }}"
                                                            value="{{ $item->p_unit_price }}"
                                                            onkeyup="chkItemPrice({{ $key }})" onclick="chkItemPrice({{ $key }})">
                                                    </td>
                                                    <td>
                                                        <input type="number" class="form-control qty" name="quantity[]"
                                                            id="quantity{{ $key }}"
                                                            onclick="chkItemOPrice({{ $key }})"
                                                            onkeyup="chkItemOPrice({{ $key }})" value="{{ $item->quantity }}">
                                                    </td>
                                                    <td>
                                                        <input type="number" class="form-control"
                                                            name="unit_price[]" id="unit_price{{ $key }}"
                ...
                @elseif (isset($list))
                    <div class="tab-pane active">
                        <form method="GET" action="{{ route('admin.purchase.finished.index') }}" class="form-inline">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a class="btn btn-warning btn-flat"
                                            href="{{ route('admin.purchase.finished.index') }}">X</a>
                                    </div>
                                </div>
                            </div>
                        </form>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right">
                                                        @can('show purchase')
                                                            <li><a href="{{ route('admin.purchase.finished.show', $val->id) . qString() }}"><i
                                                                        class="fa fa-eye"></i> Show</a></li>
                                                        @endcan
                                                       
                                                        @can('edit purchase')
                                                            <li><a href="{{ route('admin.purchase.finished.edit', $val->id) . qString() }}"><i
                                                                        class="fa fa-pencil"></i> Edit</a></li>
                                                        @endcan

                                                        @can('delete purchase')
                                                            <li><a onclick="deleted('{{ route('admin.purchase.finished.destroy', $val->id) . qString() }}')"><i
    ...
    <script>
       ...
       function checkProduct(key) {
        ...
        function addRow(key) {
            ...
            var colorOptions = $('#color_id' + key).html();
            var pUnitOptions = $('#punit_id' + key).html();
            ...
            var html = `<tr class="subRow" id="row` + newKey + `">
                ...
                <td>
                    <input type="number" class="form-control qty" name="quantity[]" id="quantity` + newKey + `" onclick="chkItemPrice(` + newKey + `)" onkeyup="chkItemPrice(` + newKey + `)">
                </td>
                <td>
                ...
                <td>
                    <input type="number" step="any" min="0" class="form-control total_price" name="amount[]" id="amount` + newKey + `" readonly>
                </td>
            </tr>`;
        ...
        //         </td>
        //         <td>
        //             <select name="p_unit_id[]" id="punit_id` + newKey + `" class="form-control select2"> ` + pUnitOptions +`
        //             </select>
        //         </td>
        //         <td>
        //             <input type="number" class="form-control" name="p_quantity[]"
        //                 id="pquantity` + newKey + `"
        //                 onclick="chkItemPrice(` + newKey + `)"
        //                 onkeyup="chkItemPrice(` + newKey + `)">
        //         </td>
        //         <td>
        //             <input type="number" class="form-control" name="p_unit_price[]" id="punit_price` + newKey + `"
        //                 onkeyup="chkItemPrice(` + newKey + `)" onclick="chkItemPrice(` + newKey + `)">
        //         </td>
        //         <td>
        //             <input type="number" class="form-control qty" name="quantity[]" id="quantity` + newKey + `" onclick="chkItemOPrice(` + newKey + `)" onkeyup="chkItemOPrice(` + newKey + `)">
        //         </td>
        //         <td>
        //             <input type="number" class="form-control" name="unit_price[]" id="unit_price` + newKey + `" readonly>
        //         </td>
        //         <td>
        //             <input type="number" step="any" min="0" class="form-control total_price" name="amount[]" id="amount` + newKey + `" readonly>
        //         </td>
        ...
        //         alerts('Please Provide Valid Quantity!');
        //     }else{
        //        var oprice = Number(amount / quantity);
        //         $('#unit_price' + key).val(Number(oprice).toFixed(2));
        //         var quantity = 0;
        //         $("input[id^='quantity']").each(function() {
        //             quantity += +$(this).val();
        //         });
