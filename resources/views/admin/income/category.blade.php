        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li {{ isset($list) ? 'class=active' : '' }}>
                    <a href="{{ route('admin.basic.income-category.index') . qString() }}">
                        <i class="fa fa-list" aria-hidden="true"></i> Category List
                    </a>
                </li>
                @can('add income_category')
                    <li {{ isset($create) ? 'class=active' : '' }}>
                        <a href="{{ route('admin.basic.income-category.create') . qString() }}">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add Category
                        </a>
                    </li>
                @endcan
                @can('edit income_category')
                    @if (isset($edit))
                        <li class="active">
                            <a href="#">
            ...
            <div class="tab-content">
                ...
                @elseif(isset($edit) || isset($create))
                    <div class="tab-pane active">
                        <div class="box-body">
                            <form method="POST"
                                action="{{ isset($edit) ? route('admin.basic.income-category.update', $edit) : route('admin.basic.income-category.store') }}{{ qString() }}"
                ...
                @elseif (isset($list))
                    <div class="tab-pane active">
                        <form method="GET" action="{{ route('admin.basic.income-category.index') }}" class="form-inline">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a class="btn btn-warning btn-flat"
                                            href="{{ route('admin.basic.income-category.index') }}">X</a>
                                    </div>
                                </div>
                            </div>
                        </form>
                                ...
                                <tbody>
                                    @foreach ($categories as $val)
                                        <tr>
                                            ...
                                            <td>
                                                @canany([
                                                    'show income_category',
                                                    'edit income_category',
                                                    'delete
                                                    income_category',
                                                    ])
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right">
                                                            @can('show income_category')
                                                                <li><a
                                                                        href="{{ route('admin.basic.income-category.show', $val->id) . qString() }}"><i
                                                                            class="fa fa-eye"></i> Show</a></li>
                                                            @endcan
                                                            @can('edit income_category')
                                                                <li><a
                                                                        href="{{ route('admin.basic.income-category.edit', $val->id) . qString() }}"><i
                                                                            class="fa fa-pencil"></i> Edit</a></li>
                                                            @endcan
                                                            @can('delete income_category')
                                                                <li><a
                                                                        onclick="deleted('{{ route('admin.basic.income-category.destroy', $val->id) . qString() }}')"><i
