        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li {{ isset($list) ? 'class=active' : '' }}>
                    <a href="{{ route('admin.payment.income.index') . qString() }}">
                        <i class="fa fa-list" aria-hidden="true"></i> Income List
                    </a>
                </li>
                @can('add income')
                    <li {{ isset($create) ? 'class=active' : '' }}>
                        <a href="{{ route('admin.payment.income.create') . qString() }}">
                ...
                @can('edit income')
                    @if (isset($edit))
                        <li class="active">
                            <a href="#">
                                <i class="fa fa-edit" aria-hidden="true"></i> Edit Income
                            </a>
                        </li>
                    @endif
                @endcan
                @can('show income')
                    @if (isset($show))
                        <li class="active">
                            <a href="#">
                                <i class="fa fa-list-alt" aria-hidden="true"></i> Income Details
                            </a>
                        </li>
                    @endif
                @endcan
            ...
            <div class="tab-content">
                    ...
                    <div class="tab-pane active">
                        <div class="box-body table-responsive">
                            <table class="table table-bordered">
                                <tr>
                                    <th style="width:120px;">Income Date.</th>
                ...
                @elseif(isset($edit) || isset($create))
                    <div class="tab-pane active">
                        <div class="box-body">
                            <form method="POST"
                                action="{{ isset($edit) ? route('admin.payment.income.update', $edit) : route('admin.payment.income.store') }}{{ qString() }}"
                ...
                @elseif (isset($list))
                    <div class="tab-pane active">
                        <form method="GET" action="{{ route('admin.payment.income.index') }}" class="form-inline">
                            <div class="box-header text-right">
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a class="btn btn-warning btn-flat" href="{{ route('admin.payment.income.index') }}">X</a>
                                    </div>
                                </div>
                            </div>
                        </form>
                                ...
                                <tbody>
                                    @foreach ($incomes as $val)
                                        <tr>
                                            ...
                                            <td>
                                                @canany(['show income', 'edit income', 'delete income'])
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right">
                                                            @can('show income')
                                                                <li><a href="{{ route('admin.payment.income.show', $val->id) . qString() }}"><i
                                                                            class="fa fa-eye"></i> Show</a></li>
                                                            @endcan
                                                            @can('edit income')
                                                                <li><a href="{{ route('admin.payment.income.edit', $val->id) . qString() }}"><i
                                                                            class="fa fa-pencil"></i> Edit</a></li>
                                                            @endcan
                                                            @can('delete income')
                                                                <li><a
                                                                        onclick="deleted('{{ route('admin.payment.income.destroy', $val->id) . qString() }}')"><i
            ...
            for (var x = 0; x < rowId; x++) {
                if (x != key) {
                    if ($('#category_id' + x).val() == categoryId) {
                        $('#category_id' + key).val('');
                        alerts('This category already exists in this Income!!');
                        return false;
                    }
                }
            }
