        ...
        <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
                <div class="tab-pane active">
                    <form method="GET" action="{{ route('admin.payment.dyeing-payments.index') }}"
                        class="form-inline">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <a class="btn btn-custom btn-flat"
                                        href="{{ route('admin.payment.dyeing-payments.index') }}">X</a>
                                </div>
                            </div>
                        </div>
                    </form>
                                ...
                                <tbody>
                                    @foreach ($records as $val)
                                        <tr>
                                            ...
                                            <td>{{ $val->type }}</td>
                                            <td>{{ $val->dyeingAgent != null ? $val->dyeingAgent->name : '' }}</td>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right">
                                                        @can('show delivery-agent-payment')
                                                            <li><a
                                                                    href="{{ route('admin.payment.dyeing-payments.show', $val->id) . qString() }}"><i
                                                        ...
                                                        @can('edit delivery-agent-payment')
                                                            @if (!$val->approved_by && auth()->user()->id == $val->created_by)   
                                                                <li><a
                                                                        href="{{ route('admin.payment.dyeing-payments.edit', $val->id) . qString() }}"><i
                                                            ...
                                                            @can('delete delivery-agent-payment')
                                                                @if (!$val->approved_by && auth()->user()->id == $val->created_by)   
                                                                <li><a
                                                                    onclick="deleted('{{ route('admin.payment.dyeing-payments.destroy', $val->id) . qString() }}')"><i
                                                        ...
                                                        @can('approval delivery-agent-payment')
                                                            ...
                                                            @if(!$val->approved_by)
                                                            <li><a onclick="activity('{{ route('admin.payment.dyeing-payments.approve', $val->id) . qString() }}', 'Are you sure to approve this payment?')"><i class="fa fa-pencil"></i> Approve</a></li>
                                                            @endif
                                                            @endif
                                                        @endcan
                                                    </ul>
