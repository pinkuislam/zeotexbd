        ...
        <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
                <div class="tab-pane active">
                    <div class="box-body">
                        <form method="POST"
                            action="{{ isset($data) ? route('admin.payment.delivery-agent-payments.update', $data->id) : route('admin.payment.delivery-agent-payments.store') }}{{ qString() }}"
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group{{ $errors->has('delivery_agent_id') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="delivery_agent_id" class="form-control select2" id="adjust_delivery_agent_id" required onchange="getAdjustDue()">
...
@push('scripts')
    <script>
        function getAdjustDue(){
            let id = $('#adjust_delivery_agent_id').val();
            if(id < 1){
                return;
            }
